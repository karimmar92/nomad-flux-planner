...
import { CONSUMER_ARBITRATION_STATEMENT, LEGAL_LAST_UPDATED, PROVIDER, VAT } from "@/config/legal";
  ...
  return (
    <LegalPage title="Imprint" subtitle="Provider identification and legal notice.">
      ...
      <LegalSection title="Business status">
        ...
        <p>
          VAT: Exempt under the small-business regulation pursuant to {VAT.basis}. No VAT is charged
          and no VAT identification number is issued under Art. 214 Directive 2006/112/EC.
        </p>
      </LegalSection>
      ...
      <LegalSection title="Consumer dispute resolution">
        <p>{CONSUMER_ARBITRATION_STATEMENT}</p>
        <p>
          The European Commission&apos;s Online Dispute Resolution platform was discontinued on 20
          July 2025, so no link to it is provided.
        </p>
      </LegalSection>

      <LegalSection title="Liability for content">
        <p>
          The contents of this website have been created with care. However, we cannot guarantee the
          accuracy, completeness or timeliness of the content. As a service provider we are
          responsible for our own content on these pages in accordance with applicable law. We are
          not obliged to monitor transmitted or stored third-party information, or to investigate
          circumstances that indicate illegal activity.
        </p>
        <p>
          Visa, tax and cost-of-living information published in {APP_NAME} is provided for guidance
          only and does not constitute legal or tax advice. See the Terms for the full position.
        </p>
      </LegalSection>
      ...
      <LegalSection title="Liability for links">
        <p>
          ...
          influence. We therefore accept no liability for that external content. The respective
      ...
      <LegalSection title="Copyright">
        <p>
          Content and works created by the site operator are subject to copyright law. Duplication,
          processing, distribution or any form of commercialisation beyond the scope of copyright
          law requires the prior written consent of the author.
        </p>
      </LegalSection>

      <p className="pt-4 text-xs text-muted-foreground">Last updated: {LEGAL_LAST_UPDATED}</p>
    </LegalPage>
  );
}
